...
// Insirindo qual o typeof Array or Object
...
const CreatePoint = () => {
    ...
    useEffect(() => {
        axios.get<IBGEUfsResponse[]>('https://servicodados.ibge.gov.br/api/v1/localidades/estados')
            .then(response => {
    ...
    function handleSelectedItems(id: number){
        // Verificador se ja possui esté id no array
        const alreadySelected = selectedItems.findIndex(item => item === id);

        if (alreadySelected >= 0) {
            // verificador para remover o item de dentro do array
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        ...
                        {/* Seleção de cidade, 
                        isto depende da seleção das UFS 
                        para mostrar os municipios do estado escolhido */}
                        <div className="field">
